...
#define Button_Start  GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_5)
#define Button_Pdf    GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_6)
#define Button_Mark   GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_7)
